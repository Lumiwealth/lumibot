...
class TestIntegrationTests:
    ...
    def test_yahoo(self):
        ...
        data_source = YahooDataBacktesting(
            datetime_start=backtesting_start, datetime_end=backtesting_end, benchmark_asset=None
        )
        ...
        parameters = {
            ...
            "portfolio_weights": [
                ...
                {"base_asset": Asset(symbol="TLT", asset_type="stock"), "weight": Decimal("0.3")},
                {"base_asset": Asset(symbol="GLD", asset_type="stock"), "weight": Decimal("0.1")},
            ],
            "shorting": False,
