...
from lumibot.tools.lumibot_logger import CSVErrorHandler, _ensure_handlers_configured, get_logger
...
class TestEnvironmentVariableHandling:
    ...
    def test_env_var_precedence_documentation(self):
        ...
        clean_env = {
            k: v for k, v in os.environ.items() if not k.startswith(("LUMIBOT_", "LOG_", "BACKTESTING_", "DISABLE_"))
        }
        ...
        with patch.dict(os.environ, clean_env, clear=True):
            ...
            csv_handlers = [h for h in root_logger.handlers if isinstance(h, CSVErrorHandler)]
