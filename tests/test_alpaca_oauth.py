...
class TestAlpacaOAuth(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.oauth_config = {"OAUTH_TOKEN": "test_oauth_token_12345", "PAPER": True}

        self.api_config = {"API_KEY": "test_api_key_12345", "API_SECRET": "test_api_secret_12345", "PAPER": True}
