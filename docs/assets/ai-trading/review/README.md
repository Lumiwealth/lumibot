...
![GitHub README: positioning and first steps](readme-top.png)

## GitHub README: runnable AI code and evidence

![GitHub README: runnable AI code and evidence](readme-code.png)

## GitHub README: compact free challenge and preserved content

![GitHub README: compact free challenge and preserved content](readme-learning.png)

## Documentation home and grouped menu

![Documentation home and grouped menu](home-desktop.png)

## AI examples with direct workflow choices

![AI examples with direct workflow choices](gallery-desktop.png)

## AI quickstart: installation and credentials

![AI quickstart: installation and credentials](quickstart-desktop.png)

## AI quickstart: canonical strategy source

![AI quickstart: canonical strategy source](quickstart-code.png)

## AI quickstart: actual run and order evidence

![AI quickstart: actual run and order evidence](quickstart-evidence.png)

## Optional learning invitation after the example

![Optional learning invitation after the example](free-challenge.png)

## Start Here: AI, Python and reusable components

![Start Here: AI, Python and reusable components](start-here.png)

## Entry point for coding agents

![Entry point for coding agents](coding-agents.png)

## Reusable components in another Python project

![Reusable components in another Python project](components.png)

## Menu, gallery and quickstart at 390 pixels

![Menu, gallery and quickstart at 390 pixels](responsive-review.png)
