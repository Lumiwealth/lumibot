    ...
    def _base_system_prompt(self, runtime_context: dict[str, Any]) -> str:
        ...
        lines = [
            ...
            *omitted_warnings,
            ...
            "After an order fills, report the actual fill prices, credit or debit, cash change, and resulting risk from orders_get_status and fresh account reads, never the planned limit or pre-trade estimate.",
