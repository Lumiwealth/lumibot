...
from lumibot.tools.projectx_helpers import ProjectX, ProjectXAuth, ProjectXClient, _to_utc_iso
...
class TestProjectXClient:
    ...
    def test_get_accounts(self, mock_client):
        ...
        mock_accounts = [{"AccountId": 12345, "AccountName": "TestAccount", "Balance": 100000.0, "Equity": 99500.0}]
    ...
    def test_get_positions(self, mock_client):
        ...
        mock_positions = [
            {"symbol": "MES", "contractId": "CON.F.US.MES.U25", "size": 5, "avgPrice": 5150.0, "unrealizedPnL": 250.0}
        ]
    ...
    def test_place_order_success(self, mock_client):
        ...
        mock_response = {"success": True, "orderId": 789012, "message": "Order placed successfully"}
    ...
    def test_cancel_order_success(self, mock_client):
        ...
        mock_response = {"success": True, "message": "Order canceled successfully"}
    ...
    def test_contract_id_conversion_no_hardcoded_mappings(self, mock_client):
        ...
        with patch.object(Asset, "get_potential_futures_contracts") as mock_contracts:
            ...
            mock_client.search_contracts = MagicMock(
                return_value=[{"contractId": "CON.F.US.UNKNOWN.U25", "Symbol": "UNKNOWN"}]
            )
    ...
    def test_get_contract_tick_size(self, mock_client):
        ...
        mock_details = {"success": True, "contract": {"TickSize": 0.25}}
...
class TestProjectXApiClient:
    ...
    def test_api_request_headers(self, mock_api_client):
        ...
        expected_headers = {"Authorization": "Bearer test_token", "Content-Type": "application/json"}
    ...
    def test_history_retrieve_bars(self, mock_api_client):
        ...
        mock_response.json.return_value = {
            "success": True,
            "bars": [{"t": "2024-01-15T09:30:00Z", "o": 5150.0, "h": 5155.0, "l": 5148.0, "c": 5152.0, "v": 1000}],
        }
