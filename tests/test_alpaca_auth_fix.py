...
class TestAlpacaAuthFix:
    ...
    def setup_method(self):
        ...
        self.config = {"API_KEY": "test_key", "API_SECRET": "test_secret"}
    ...
    def test_auth_failed_flag_not_set_for_network_errors(self):
        ...
        network_error = RuntimeError("Connection timeout")
    ...
    def test_get_chains_blocked_after_auth_failure(self, mock_client_class):
        ...
        mock_client.get_option_chain.return_value = {"option_chains": {}}
