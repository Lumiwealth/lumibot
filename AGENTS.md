...
- Do not generate robot or mascot variations for LumiBot documentation or README illustrations. Repeated generated Spot variants were explicitly rejected. Use relevant character-free illustrations or approved creator photography. The existing official navigation logo is a separate unchanged brand asset; it is not permission to invent new poses or faces. Never reuse a rejected output as a reference or describe it as approved.
