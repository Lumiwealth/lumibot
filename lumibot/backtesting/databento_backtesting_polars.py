...
from lumibot.entities import Asset, Data, Bars
    ...
    def get_historical_prices(
        ...
        if cache_key in self._filtered_data_cache:
            ...
            if 'datetime' in cached_df.columns:
                ...
                # Check cache validity without collecting entire dataset
                # Only collect the single max value for efficiency
        ...
        try:
            ...
            if 'datetime' not in df_result.columns and 'datetime' in df_filtered.columns:
                logger.warning(f"[get_historical_prices] datetime column was dropped by tail()! This is a bug.")
