...
10) Clean up repo-root “AI markdown” files (user request):
   - Move `THETADATA_INVESTIGATION_2025-12-11.md` into `docs/thetadata/investigations/`.
   - Move `THETADATA_BACKTESTING_HANDOFF_2025-12-17.md` (and other handoffs) into `docs/thetadata/handoffs/`.
