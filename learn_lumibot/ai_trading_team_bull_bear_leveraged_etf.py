...
class AITradingTeamBullBearLeveragedETFStrategy(Strategy):
    ...
    def initialize(self):
        self.sleeptime = "1D"
        model = os.environ.get("AI_TRADING_TEAM_MODEL", "gemini-3.6-flash")
...
if __name__ == "__main__":
    ...
    if IS_BACKTESTING:
        ...
        start = datetime(2026, 4, 7, tzinfo=nyc)
        end = datetime(2026, 5, 22, tzinfo=nyc)
        ...
        broker = Alpaca(get_alpaca_config())
