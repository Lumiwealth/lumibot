...
fp_package_mock.fp = fp_submodule_mock
...
for mod_name in autodoc_mock_imports:
    if mod_name not in sys.modules:
        ...
        if mod_name == "scipy":
            ...
            mock_obj.parquet = _parquet_mock
            sys.modules[parquet_mod_name] = _parquet_mock

        elif mod_name == "ibapi":
            mock_obj.__path__ = [mod_name.replace('.', '/')]
            mock_obj.TickerId = MagicMock(name="TickerId", __module__=mod_name)
            mock_obj.TickType = MagicMock(name="TickType", __module__=mod_name)
            mock_obj.OrderId = MagicMock(name="OrderId", __module__=mod_name)
            mock_obj.SetOfString = MagicMock(name="SetOfString", __module__=mod_name)
            mock_obj.SetOfFloat = MagicMock(name="SetOfFloat", __module__=mod_name)
            ...
            _client_mock.TickerId = MagicMock(name="TickerId", __module__=client_mod_name)
            _client_mock.TickType = MagicMock(name="TickType", __module__=client_mod_name)
            _client_mock.OrderId = MagicMock(name="OrderId", __module__=client_mod_name)
            _client_mock.SetOfString = MagicMock(name="SetOfString", __module__=client_mod_name)
            _client_mock.SetOfFloat = MagicMock(name="SetOfFloat", __module__=client_mod_name)
            _client_mock.EClient = type("EClient", (object,), {"__module__": client_mod_name})
            mock_obj.client = _client_mock
            ...
            _wrapper_mock.EWrapper = type("EWrapper", (object,), {"__module__": wrapper_mod_name})
            ...
            _common_mock.TickerId = MagicMock(name="TickerId", __module__=common_mod_name)
            _common_mock.OrderId = MagicMock(name="OrderId", __module__=common_mod_name)
            _common_mock.SetOfString = MagicMock(name="SetOfString", __module__=common_mod_name)
            _common_mock.SetOfFloat = MagicMock(name="SetOfFloat", __module__=common_mod_name)
            ...
            _ticktype_mock.TickType = MagicMock(name="TickType", __module__=ticktype_mod_name)
            mock_obj.ticktype = _ticktype_mock
            ...
            _contract_mock.SetOfString = MagicMock(name="SetOfString", __module__=contract_mod_name)
            _contract_mock.SetOfFloat = MagicMock(name="SetOfFloat", __module__=contract_mod_name)
            mock_obj.contract = _contract_mock
            ...
            mock_obj.client = _client_mock_schwab
            ...
            mock_obj.streaming = _streaming_mock_schwab
            ...
            mock_obj.exceptions = _exceptions_mock
...
if not isinstance(historical_mock, MagicMock) or not hasattr(historical_mock, '__path__'):
    ...
    data_mock.historical = historical_mock
...
if not isinstance(requests_mock, MagicMock):
    ...
    data_mock.requests = requests_mock
...
if not isinstance(trading_mock, MagicMock):
    ...
    alpaca_mock.trading = trading_mock
