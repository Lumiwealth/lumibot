...
Local cache path override behavior is controlled by ``LUMIBOT_CACHE_FOLDER``; see the canonical scheduled-execution entry above. This is useful when simulating a fresh container/task.
